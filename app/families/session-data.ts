...
export const familySessions: FamilySession[] = [
  {
    ...
    images: [
      { src: "/walnut-creek-family-photography-graham-dad-daughter.jpg", alt: "Father lifting his laughing daughter beneath the oak trees" },
      { src: "/walnut-creek-family-photography-graham-child-portrait.jpg", alt: "Joyful black-and-white portrait from the Graham family session" },
      { src: "/walnut-creek-family-photography-graham-sunset-silhouette.jpg", alt: "Graham family silhouetted beneath oak trees at sunset" },
    ],
  },
  {
